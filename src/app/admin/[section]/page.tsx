...
const sectionPermission:Record<AdminSection,string>={"pending-users":"view_all_users",users:"view_all_users",stations:"view_all_stations",roles:"create_role",permissions:"create_permission",operators:"manage_operators","audit-logs":"view_audit_logs"};
...
export default async function AdminSection({params,searchParams}:{params:Promise<{section:string}>;searchParams:Promise<{saved?:string;error?:string}>}){
  ...
  await requirePermission(sectionPermission[currentSection]);
