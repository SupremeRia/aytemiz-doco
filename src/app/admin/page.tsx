...
import { Activity, Building2, ChevronRight, FileText, KeyRound, MessageSquare, Newspaper, Shield, UserCheck, Users } from "lucide-react";
...
export default async function Admin() {
  ...
  const contentEntries=[permissions.has("messages.moderate")?["/dashboard#stations",MessageSquare,"Sohbet moderasyonu","İstasyon sohbetlerine çalışma alanından erişin"]:null,permissions.has("files.upload")?["/dashboard#stations",FileText,"Dosyalar","İstasyon belgelerini çalışma alanından yönetin"]:null,permissions.has("news.create")?["/news/manage",Newspaper,"Haberler","Kurumsal haber oluşturun ve yayınlayın"]:null].filter(Boolean) as [string,typeof MessageSquare,string,string][];
